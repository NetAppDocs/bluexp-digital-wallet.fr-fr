...
+
Chaque mosaïque fournit une vue d'ensemble graphique de l'état de la capacité tandis que la page de détails vous permet de voir et de gérer les modes de paiement de cette capacité.
